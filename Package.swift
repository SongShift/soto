...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/soto-project/soto-core.git", .branch("cross-compile-env-var"))
    ],
    targets: [
        ...
        .target(name: "SotoS3Control", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/", sources: ["Services/S3Control", "Extensions/S3Control"]),
